...
jsPsych.plugins["2image-keyboard-response"] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      var after_response = function(info) {
        ...
        display_element.querySelector('#jspsych-2image-keyboard-response-stimulus').className += ' responded';
      ...
      if (trial.stimulus_duration !== null) {
        jsPsych.pluginAPI.setTimeout(function() {
          display_element.querySelector('#jspsych-2image-keyboard-response-stimulus').style.visibility = 'hidden';
